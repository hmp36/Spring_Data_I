...
module.exports = (function () {
    return {
        ...
        deepQuestion: function (req, res) {
			...
			// last one is the DEEP get question, i think.. need to deep get the question's answers and other user who made that answer. DO THIS last
